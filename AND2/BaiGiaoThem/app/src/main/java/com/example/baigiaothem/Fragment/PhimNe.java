...
public class PhimNe extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_phim_ne, container, false);
        recyclerView = view.findViewById(R.id.rcvPhim);
        fltAdd = view.findViewById(R.id.fltAddPhim);
        phimDao = new PhimDao(getActivity());
        recyclerView.setLayoutManager(new GridLayoutManager(getContext(), 2));
        list = phimDao.selectAll();
        adapter = new PhimAdapter(getActivity(), list);
